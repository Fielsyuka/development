...
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime */ "./node_modules/regenerator-runtime/runtime.js");
...
/* harmony import */ var _sass_style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../sass/style.scss */ "./src/assets/sass/style.scss");
/* harmony import */ var _modal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modal.js */ "./src/assets/js/modal.js");
/* harmony import */ var _tab_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tab.js */ "./src/assets/js/tab.js");
...
var main = {
  ...
  setupEventListeners: function setupEventListeners() {
    // Modal
    _modal_js__WEBPACK_IMPORTED_MODULE_5__.default.init(".js-modal-trigger", ".js-modal-close"); // Tab

    var tab1 = new _tab_js__WEBPACK_IMPORTED_MODULE_6__.default(1);
    var tab2 = new _tab_js__WEBPACK_IMPORTED_MODULE_6__.default(2);
  }
};
main.init(); // const init = (settings) => {
//   console.log("test");
...
var initTest = /*#__PURE__*/function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  init: function init(triggerSelector, clearSelector) {
    ...
    var _iterator2 = _createForOfIteratorHelper(clearNode),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var clear = _step2.value;
...
var Tab = /*#__PURE__*/function () {
  function Tab(id) {
    ...
    this.id = id;
    this.tab = document.getElementById("tab-".concat(this.id));
    this.active = 0;
  ...
  _createClass(Tab, [{
    ...
    value: function handleClick() {
      ...
      var _loop = function _loop(i) {
        _this.triggers[i].addEventListener("click", function (e) {
          e.preventDefault();
          this.handleActive(i);
        }.bind(_this));
      };
